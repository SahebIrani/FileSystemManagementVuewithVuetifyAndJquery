                ...
                if (status === 'success') {
                    ...
                    if (obj.children('div').length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            var strTab = 'padding:10px;margin-bottom: 8px;margin-left:' + tab + 'px;';
                            ...
                            if (data[i].isFile) {
                                ...
                                obj.append('<div id="' + id + index + '" style="padding:10px;' + strTab + '"><span ' + title
                                ...
                                obj.append('<div id="' + id
                                    + index + '" style="padding:10px;border:solid 1px white;' + strTab
