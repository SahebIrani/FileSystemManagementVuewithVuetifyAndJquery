    ...
    var index = 0,
                            ...
                            if (data[i].isFile) {
                                ...
                                const folderResult = `<div id=${id}${index} class="${strTabClass} border p-2" style="${strTabStyle} cursor:pointer;">
                                                            <span ${title} ${style} ${onClick}>
                                                                   <i id="${i}${index}" class="folder mr-4"></i>
                                                                   ${name}
                                                            </span>
                                                      </div>`
                                    ;
        ...
        getIconFromExtension = function (file) {
            ...
            switch (extension.toLowerCase()) {
                case 'rar': extension = 'file-archive'; break;
                case 'zip': extension = 'file-archive'; break;
                case 'pdf': extension = 'file-pdf'; break;
                case 'docx': extension = 'file-word'; break;
                case 'doc': extension = 'file-word'; break;
                case 'xlsx': extension = 'file-excel'; break;
                ...
                case 'bmp': extension = 'file-image'; break;
                case 'png': extension = 'file-image'; break;
                case 'gif': extension = 'file-image'; break;
                case 'jpg': extension = 'file-image'; break;
