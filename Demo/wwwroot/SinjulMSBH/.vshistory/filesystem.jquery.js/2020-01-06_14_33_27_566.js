                ...
                if (status === 'success') {
                    ...
                    if (obj.children('div').length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            var strTab = `padding:10px;margin: 8px 0 8px 0;margin-left:${tab}px;`;
                            ...
                            if (data[i].isFile) {
                                ...
                                var appendResult = `<div id=${id}${index} style="${strTab}"><span ${strTab}><i class="far fa-${extension}" style="margin-right:5px"></i></span></div>`;
