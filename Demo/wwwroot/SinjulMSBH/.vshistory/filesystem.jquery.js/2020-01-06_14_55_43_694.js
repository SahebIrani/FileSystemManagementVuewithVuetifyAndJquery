                    ...
                    if (obj.children('div').length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (data[i].isFile) {
                                ...
                                const appendResult = `<div id=${id}${index} class="${strTabClass} mt-4" style="${strTabStyle}">
                                                        <span ${strTabStyle}>
                                ...
                                const folderResult = `<div id=${id}${index} clas="${strTabClass}" style="${strTabStyle}" ${onClick}>
